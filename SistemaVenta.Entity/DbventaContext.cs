...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP\\SQLEXPRESS; DataBase=DBVENTA;Integrated Security=true; Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C1DFA168D");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FE544468B");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4837C8DF555");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107D56779B1");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E85215735");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13238B0F985");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76696C6971");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D88E9D991E");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE29F4A18B");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6A1709743");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56144BEC1525");
